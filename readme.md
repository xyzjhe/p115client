[![Generic badge](https://img.shields.io/badge/Telegram%20Group-join-blue?logo=telegram)](https://t.me/PredawnTalk)
![license](https://img.shields.io/github/license/ChenyangGao/p115client.svg)
...
[p115client](https://github.com/ChenyangGao/p115client) 是一个 [115 网盘](https://115.com) 的 [Python](https://python.org) 客户端模块 by [ChenyangGao](https://github.com/ChenyangGao)

支持同步和异步操作，全面封装了各种 **web**、**app** 和 **open** 接口。
...
从根本上讲，除了几个直接以 `staticmethod` 方式调用的接口外，它们都会调用 `P115Client.request`
